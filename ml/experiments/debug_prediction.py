...
# Add inference service to path
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'services', 'inference-service', 'app'))
from face_detection import FaceDetector

model_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "services", "inference-service", "model", "veriface_model.h5")
test_image_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "services", "api-service", "uploads", "5a55de5d-14cb-4542-ac16-fda64dfc22e5.jpg")
